...
protected:
	...
	class UAkAudioEvent* assault_rifle_reload;

	// Weapon Out of Ammo
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Wwise)
	class UAkAudioEvent* assault_rifle_out_of_ammo;

	// Assault Rifle Fire Loop
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Wwise)
	class UAkAudioEvent* assault_rifle_fire_loop;
	
	// Assault Rifle Fire Tail
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Wwise)
	class UAkAudioEvent* assault_rifle_fire_tail;

	// Launcher Projectile
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Wwise)
	class UAkAudioEvent* launcher_projectile;
